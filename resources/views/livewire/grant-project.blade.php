                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            ...
                            <tbody>
                                ...
                                <tr data-aos="zoom-in-down" data-aos-duration="1000">
                                    ...
                                    <td class="align-middle">{{ $project->student->college->name }}
                                    </td>
                                    <td class="align-middle">{{ $project->student->dept->name }}
                                    </td>
                                ...
                                @empty
                                <tr class="mt-4">
                                    <td colspan="6" class="text-center h5">No grant project found :(
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
