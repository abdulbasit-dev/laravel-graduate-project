<section class="container" id="ideas">
    ...
    {{--filter --}}
        <div class="row">
            ...
            <div class="row justify-content-center row-cols-lg-auto  align-items-center" data-aos="fade-up"
                                ...
                                <table class="table table-centered table-nowrap mb-0 rounded">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-aos="zoom-in-down" data-aos-duration="1000">
                                            ...
                                            <td class="align-middle">{{ $idea->student->college->name }}
                                            </td>
                                        ...
                                        @empty
                                        <tr class="mt-4">
                                            <td colspan="7" class="text-center h4">No grant idea found :(
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
