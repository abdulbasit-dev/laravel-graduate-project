                        ...
                        <div class="accordion-body">
                            ...
                            <div class="card card-body" dir="rtl">
                                <div class="d-flex align-items-center justify-content-around mb-5 mt-3">
                                    ...
                                    <img src="{{ asset('images/brand.png') }}" alt="univertsy logo" class="img-fluid"
                                        style="width: 80px">
                                </div>
                                <form class="px-5">
                                    ...
                                    <div>
                                        <div class="row g-3 align-items-start mb-5">
                                            ...
                                            <div class="col-8">
                                                <textarea name="field" id="field" rows="4" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-3 align-items-start mb-5">
                                            ...
                                            <div class="col-8">
                                                <textarea name="friend" id="friend" rows="4" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="border-top mt-5 ">
                                        ...
                                        <div class="row flex-column mt-3">
                                            ...
                                            <div class="col">
                                                <textarea name="advantage" id="advantage" rows="5" class="form-control border-0"
                                                    style=" resize: none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-3">
                                                <div class="d-flex flex-column">
                                                    <label for="field" class="col-form-label">پڕۆژەی دەرچوون لە
                                                        کام
                                                        بوارە؟</label>
                                                    <span class="text-primary" style="font-size: .9rem !important;">(پێویستە
                                                        قوتابی
                                                        پوختەیەک لە
