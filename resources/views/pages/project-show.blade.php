                    ...
                    <article>
                        ...
                        <section class="mb-5">
                            <h4>College: <span class="h4 text-muted">{{
                                    $project->student->college->name }}</span></h4>
                            <h4>Department: <span class="h4 text-muted">{{
                                    $project->student->dept->name }}</span></h4>
                            ...
                            <div class="mb-3">
                                ...
                                <h5 class="text-secondary">{{ $loop->iteration }}. {{ $team }}</h5>
                                @endforeach
                            </div>
                            ...
                            <div class="d-flex mt-5">
                                <div class="text-center">
                                    ...
                                    <a href="{{ asset($project->report) }}" download="">
                                        <svg class="text-primary" style="width: 3rem" fill="none" stroke="currentColor"
