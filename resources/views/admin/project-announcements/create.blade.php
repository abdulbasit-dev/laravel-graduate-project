    ...
    <div class="row">
        <div class="col-12 col-xl-12">
            <div class="card card-body mb-4 border-0 shadow">
                <form action="{{ route('admin.project-announcements.store') }}" method="POST"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-10 mb-3">
                            ...
                            <textarea
                                class="form-control tinymce @error('title') is-invalid @enderror"
                                rows="6" id="title" name="title">{{ old('title') }}</textarea>
                            @error('title')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-3">
                        <button class="btn btn-gray-800 animate-up-2 mt-2"
                            type="submit">Submit</button>
                        <button class="btn btn-gray-200 animate-up-2 ms-3 mt-2"
