...
<div class="col-12 col-xl-12">
    <div class="card card-body border-0 shadow mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <h2 class="h5 mb-4">Edit Your Project</h2>
            <a href="{{ route('admin.profile.project') }}">
            ...
            <div class="row mt-3">
                <div class="col-md-8 mb-3">
                    ...
                    <input class="form-control" id="title" type="text" name="title"
                        placeholder="Enter your project title" required value="{{ old("
                        title",$project->title) }}">
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-8 mb-3">
                    ...
                    <input class="form-control" id="supervisor_name" type="text"
                        name="supervisor_name" placeholder="Enter your supervisor name" required value="{{ old("
