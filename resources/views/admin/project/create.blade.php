            ...
            <form action="{{ route('admin.projects.store') }}" method="POST">
                ...
                <div class="row mt-3">
                    <div class="col-md-8 mb-3">
                            ...
                            <input class="form-control" id="supervisor_name" type="text" name="supervisor_name"
                                placeholder="Enter your supervisor name" required>
                    </div>
                </div>
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-8 mb-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <svg class="icon btn_add ms-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        ...
                        <div class="team_members">
                            <div class="d-flex">
                                ...
                                <button type="button" class="btn btn-danger ms-3 btn-sm" style="visibility: hidden"><svg
                ...
                <div class="row mt-3">
                    <div class="col-md-8 mb-3">
                            <label for="formFile" class="form-label">Upload your report</label>
