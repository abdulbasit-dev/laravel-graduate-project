                    ...
                    <div class="row mt-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-4">
                                ...
                                <small id="emailHelp" class="form-text text-muted">choose a a file
                                    with size (1920 x 1280 ). use this website <span
                                        class="text-muted">https://unsplash.com/s/photos/project?orientation=landscape</span>
                                </small>
                                @error('file')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
